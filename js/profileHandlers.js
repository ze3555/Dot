...
// HTML: #profile-top, #profile-top-backdrop, #edit-username-btn, #copy-id-btn,
//       #profile-username, #add-username-input, #add-username-btn
...
export function setupProfileDrawer() {
  ...
  // Triggers: Dot menu "Function" + double-click on Dot
  document.addEventListener("dot:function", () => open());
